...
export default function UpdatePost({ post, postId }: UpdatePostProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 🔥 Replace with your backend update API
            const response = await axios.patch(
                `https://mini-blog-backend-10400.vercel.app/api/post/${postId}`,
                updatedPost
            );
    ...
    return (
        <div className="mx-auto mt-10 bg-black text-white p-8 pt-5 rounded-b-2xl shadow-lg">
            <h1 className="text-3xl font-bold text-indigo-400 mb-6">Update Post</h1>
